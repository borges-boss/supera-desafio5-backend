...
public class TransferenciaService {
    ...
    public Transferencia save(Transferencia transferencia) throws Exception {
        return transferenciaRepositoryImp.save(transferencia);
    }

    public List<Transferencia> findAll() throws Exception {
        return transferenciaRepositoryImp.findAll();
    }

    public void deleteById(long id) throws Exception {
        transferenciaRepositoryImp.deleteById(id);
    }

    public List<Transferencia> getTransferenciaByFilter(String dataTransferenciaStart, String dataTransferenciaEnd,
            String nomeOperadorTransacao) throws Exception {
